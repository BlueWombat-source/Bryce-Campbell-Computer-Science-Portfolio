 ...
 */
int partition(vector<Bid>& bids, size_t begin, size_t end) {
    ...
    size_t middlePoint = low + (high - low) / 2;
...
int main(int argc, char* argv[]) {
    ...
    while (choice != 9) {
        ...
        case 3:
            ...
            // Call the method to initiate selection sort
            selectionSort(bids);
        ...
        // FIXME (2b): Throws an unhandled exception, Stack Overflow error
        // Tried to increase size of all variables to avoid overflowing int size, did not work.
        case 4:
            // Initialize a timer variable before loading bids
            ticks = clock();

            // Call the method to initiate quick sort
            ...
            // Calculate elapsed time and display result
            ticks = clock() - ticks;
            cout << "time: " << ticks << " clock ticks" << endl; // current clock ticks minus starting clock ticks
            cout << "time: " << ticks * 1.0 / CLOCKS_PER_SEC << " seconds" << endl;
